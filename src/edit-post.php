...
$_SESSION["post"]["uuid"] = $Post->uuid;
$_SESSION["post"]["thumbnail"] = $Post->thumbnail;
$_SESSION["post"]["title"] = $Post->title;
$_SESSION["post"]["content"] = $Post->content;
...
<body>
<main class="constrain" id="edit-post">
    <p class="error"></p>
        ...
        <div class="responsive">
            ...
            <div class="input">
                ...
                <textarea name="content" id="content"
                          placeholder="Your message..."><?= Filter::br2nl($Post->content) ?></textarea>
                <p class="tooltip">Links are supported! e.g. https://google.com</p>
            </div>
        </div>
        <div class="input">
            <label for="thumbnail">Thumbnail</label>
            <input type="file" name="thumbnail" id="thumbnail" class="file"/>
            <?php if ($Post->thumbnail) { ?>
                <figure class="previous">
                    <img src="<?= $Post->thumbnail ?>" alt="Current post thumbnail.">
                    <figcaption><?= human_filesize(filesize($Post->thumbnail)) ?></figcaption>
                </figure>
            <?php } ?>
            <div class="dropzone">
            ...
            <p class="tooltip">Choosing a new image is optional.<br>If you do, the previous one will be deleted.</p>
        </div>

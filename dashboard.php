                    ...
                    <?php foreach (
                        ...
                        <div class="post">
                            <?php if ($row["thumbnail"] !== null) { ?>
                                <div class="thumbnail" style="background-image: url('<?= $row[
                                    "thumbnail"
                                ] ?>')"></div>
                            <?php } ?>
                            <div class="text">
                            ...
                            <div class="controls-signature-container">
                                ...
                                <?php if (
                                    ...
                                    <div class="controls">
                                        <a class="delete" href="/delete-post?id=<?= $row[
                                            "id"
                                        ] ?>">
                                        ...
                                        <a class="edit" href="/edit-post?id=<?= $row[
                                            "id"
                                        ] ?>">
            ...
            <div id="participant-list">
                <?php foreach (
                    ...
                    <div class="participant">
                        <div class="avatar" style="background-image: url('<?= $row[
                            "avatar"
                        ] ?>')"></div>
                        <div class="text">

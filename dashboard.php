    ...
    <body>
        ...
        <div id="dashboard-container">
            ...
            <div id="main">
                ...
                <div id="title-bar">
                    <h2>Dashboard</h2>
                    <a href="/new-post" class="new-post-button">
                ...
                <div id="posts-container">
                    <div id="posts-overflow" data-masonry='{"itemSelector": ".post", "columnWidth": ".grid-sizer", "gutter": 10}'>

                        <div class="grid-sizer" style="width: 32%"></div>
                        ...
                        <?php foreach ($sql_connection -> query(
                            'SELECT
                                ...
                                posts.title,
                                posts.content,
                                DATE_FORMAT(posts.pub_time, "%b %c, %Y") AS formatted_pub_time,
                                posts.edited,
                                posts.user_id,
                                users.username
                            FROM
                            ...
                            <div class="post">
                                ...
                                <div class="controls-signature-container">
                                    ...
                                    <?php if ($row['user_id'] == $User -> user_id) { ?>
                                        ...
                                        <div class="controls">
                                            <a class="delete" href="/delete-post/<?= $row['id'] ?>">
                                            ...
                                            <a class="edit" href="/edit-post/<?= $row['id'] ?>">

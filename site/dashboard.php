...
<body>
    <div id="overlays" style="opacity: 0;">
        <div class="overlay" id="edit" style="display: none; opacity: 0; transform: translateY(-20px);">
            <div class="loader" style="display: flex; opacity: 1">
                <span class="ball"></span>
                <span class="ball"></span>
                <span class="ball"></span>
            </div>
            <form id="edit-post" class="disabled" method="POST" enctype="multipart/form-data">
                <div class="titlebar">
                        ...
                        <div class="controls">
                            ...
                            <?php if ($row["author"] == $User->uuid) { ?>
                                <div class="buttons">
                                    ...
                                    <button class="icon edit" onclick="getPost(this, '<?= $row["uuid"] ?>')">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
